  ...
  return (
    <main>
      ...
      <section className="products-section container py-5">
        <div className="category-nav d-flex justify-content-center gap-4 flex-wrap">
          ...
          <div className="category-card">
            ...
            <div className="category-img-container">
              <img src="    https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTleBaLEk1ZiI2y_BoVnq4B2ceViVbDcWQCTb6JXNdNfA&s=10" alt="Combo" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="promociones container py-5">
        ...
        <ul className="row row-cols-1 row-cols-md-3 row-cols-lg-5 g-4 list-unstyled">{[1, 2, 3, 4, 5].map((index) => (<li className="col" key={index}>
          ...
          <div className="col-md-6">
            <article className="info-card d-flex align-items-center shadow-sm border rounded-3 overflow-hidden bg-white">
              ...
              <div className="card-text w-100 p-4 text-start">
                <h4 className="fw-bold fs-5 text-uppercase">Descubre nuestras zonas de reparto</h4>
